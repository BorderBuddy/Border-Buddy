...
export const Success = () => (
  <div id="success-container">
    ...
    <h3 className="center">{`Hello, ${this.props.res.name}!`}</h3>
    <h4 className="center">
      We have created a secure record of your travel information.
    </h4>
    <h4 className="center">{`Two hours after you land, we will send a text to +${this.props.res.countryCode}${this.props.res.phone}`}</h4>
    <h4 className="center">
