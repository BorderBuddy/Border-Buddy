...
const dummyTravelers = [
	...
	{ email: 'anthony@abc.com', phone: '2928773366', name: 'DT Jacksern', status: 'transit', connectivity: true, nationality: 'Sudan', flight_id: 1},
	{ email: 'melbrux@abc.com', phone: '2027740729', name: 'Fraulein Hhauserr', status: 'transit', connectivity: true, nationality: 'Sudan', flight_id: 1}
]
